...
public class NewsDetails_User extends AppCompatActivity {
ImageView IV_news_det_back,IV_news_det_image;
TextView TV_news_det_title,TV_news_det_type,TV_nes_det_desc;
...
@Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_details__user);
...
else
{
    ...
    IV_news_det_back.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            startActivity(new Intent(NewsDetails_User.this,News_Display.class));
        }
    });
    }
