...
public class Settings_Profesional_Edit_Vendor extends AppCompatActivity {
    EditText ET_pedit_companyname,ET_pedit_businesscontact,ET_pedit_bemail,ET_pedit_location;
        ...
        if (isConnectedToNetwork()) {
          ...
          ET_pedit_location = findViewById(R.id.ET_pedit_location);
            ...
            ET_pedit_location.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                  //  startActivity(new Intent(Settings_Profesional_Edit_Vendor.this,SelectLocation.class));
                }
            });
...
//                    ET_pedit_category.append(spinnerArray_name.get(i));
//                }
