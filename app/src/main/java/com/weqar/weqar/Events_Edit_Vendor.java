...
public class Events_Edit_Vendor extends AppCompatActivity implements DatePickerDialog.OnDateSetListener,TimePickerDialog.OnTimeSetListener{
    ImageView iv_uedit_events_back,iv_editevent_image;
    TextView et_editevent_startdate,et_editevent_enddate;
    ...
    String s_lnw_userid,s_lnw_usertoken,s_eventedit_uid,s_eventedit_id,s_eventedit_startdate,s_eventdedit_enddate,s_eventedit_contact,
            s_evenedit_title,s_eventedit_amount,s_eventedit_desc,s_eventedit_iamge,event_startdate_one;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_events__edit__vendor);
...
//                et_editevent_enddate.setText(s_eventdedit_enddate);
            ...
            iv_uedit_events_back.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(Events_Edit_Vendor.this, Events_Display_Vendor.class));
                }
            });
        ...
        else
        {
            ...
            but_retry.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Events_Edit_Vendor.this, Events_Display_Vendor.class);
    ...
    public void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute) {
        ...
        if(two==1)
        {
            et_editevent_startdate.setText(event_startdate_one+" "+timeFormat.format(calendar.getTime()));

        }
        else
        {
            et_editevent_enddate.setText(event_startdate_one+" "+timeFormat.format(calendar.getTime()));
    ...
    public void callmetoupload_editevnts()
    {
        try
        {
            ...
            if (et_editevent_startdate.getText().toString().equals("")) {
                new PromptDialog(Events_Edit_Vendor.this)
                            ...
                            if(et_editevent_amount.getText().toString().equals("")) {
                                ...
                                else
                                {
                                    ...
                                    callmetouploadvendorcomplete_url(s_lnw_userid,s_eventedit_id,s_eventedit_startdate,s_eventdedit_enddate,s_eventedit_contact,
                                            s_evenedit_title,
                                            s_eventedit_amount,s_eventedit_desc,s_eventedit_iamge);
    ...
    public void callmetouploadvendorcomplete_url(final String s_lnw_user_ids,final String id,
                                                 ...
                                                 final String amount,final String desc,final String image)
    {
        try {
